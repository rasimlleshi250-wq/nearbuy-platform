...
const ZONES = ["Tiranë - Qendër", "Tiranë - Kombinat", "Tiranë - Kashar", "Tiranë - Tjetër", "Durrës", "Tjetër"];
      ...
      <main className="cs-main">
        ...
        <div className="cs-hero">
          ...
          <div className="cs-stats">
            ...
            <div className="cs-stat-divider" />
            <div className="cs-stat">
              <span className="cs-stat-num">Falas</span>
              <span className="cs-stat-label">gjithmonë për bizneset</span>
            </div>
          </div>
