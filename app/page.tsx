    ...
    <main className="nb-home">
      ...
      <section className="nb-hero">
        ...
        <div className="nb-hero-content">
          ...
          <div className="nb-search">
            ...
            />
            <button className="nb-search-btn">Kërko</button>
          </div>
      ...
      <style>{`
        ...
        .nb-nav-login {
          ...
          color: #a8a29e; font-size: 0.875rem; font-weight: 500;
        ...
        .nb-search-icon {
          padding: 0 14px; color: #52524e; flex-shrink: 0;
          display: flex; align-items: center;
        }
        .nb-search-input {
          flex: 1; padding: 1rem 0.5rem;
          background: transparent; border: none; outline: none;
          color: #f5f5f4; font-size: 0.95rem;
        }
        .nb-search-input::placeholder { color: #44403c; }
        .nb-search-btn {
          margin: 6px; padding: 0.65rem 1.4rem;
          background: #f5c842; color: #0a0a0a;
          font-size: 0.875rem; font-weight: 700;
        ...
        @media (max-width: 640px) {
          ...
          .nb-hero { padding: 5rem 1rem 3rem; }
          .nb-search { border-radius: 12px; }
        }
      `}</style>
    </main>
  );
