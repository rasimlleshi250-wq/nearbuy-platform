    ...
    <main className="setup-root">
      ...
      <div className="setup-card">
        ...
        <div className="setup-titles">
          {step === 1 && <><h1>Të dhënat e biznesit</h1><p>Informacioni bazë i dyqanit tënd</p></>}
          {step === 2 && <><h1>Orari i punës</h1><p>Kur është i hapur dyqani yt?</p></>}
          {step === 3 && <><h1>Foto & Logo</h1><p>Bëje profilin tënd më tërheqës (opsionale)</p></>}
        </div>
        ...
        {step === 1 && (
          <div className="setup-fields">
            <div className="setup-field">
              ...
              <input type="text" placeholder="p.sh. Elektronika ABC" value={form.name}
            ...
            <div className="setup-field">
              ...
              <input type="text" placeholder="Rruga, numri, lagja..." value={form.address}
                onChange={e => setForm(p => ({ ...p, address: e.target.value }))} />
            </div>

            <div className="setup-field">
              <label>Përshkrim i shkurtër</label>
              <textarea rows={3} placeholder="Çfarë shet dyqani yt? Çfarë e bën të veçantë?..."
                value={form.description}
                onChange={e => setForm(p => ({ ...p, description: e.target.value }))} />
              <span className="setup-hint">{form.description.length}/200 karaktere</span>
            </div>
        ...
        {step === 3 && (
          <div className="setup-photos">
            <div className="setup-field">
              <label>Logo e dyqanit</label>
              <label className="photo-upload-area">
                <input type="file" accept="image/*" onChange={e => handleImageChange("logo", e)} style={{ display: "none" }} />
                {logoPreview ? (
                  <img src={logoPreview} alt="logo" className="photo-preview logo-preview" />
                ) : (
                  <div className="photo-placeholder">
                    <span>🏪</span>
                    <span>Ngarko logon</span>
                    <span className="photo-hint">PNG, JPG · Max 2MB</span>
                  </div>
                )}
              </label>
            </div>
            ...
            <div className="setup-field">
              <label>Foto e dyqanit (Cover)</label>
              <label className="photo-upload-area cover-area">
                <input type="file" accept="image/*" onChange={e => handleImageChange("cover", e)} style={{ display: "none" }} />
                {coverPreview ? (
                  <img src={coverPreview} alt="cover" className="photo-preview cover-preview" />
                ) : (
                  <div className="photo-placeholder">
                    <span>📸</span>
                    <span>Ngarko foton e dyqanit</span>
                    <span className="photo-hint">Rekomandohet 1200×400px</span>
                  </div>
                )}
              </label>
            </div>
